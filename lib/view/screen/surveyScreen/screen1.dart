...
class _Screen1State extends State<Screen1> {
  final SurveyScreen1Controller allScreenController =
    ...
    return Obx(
      () => Column(
        ...
        children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: CustomButton(
                          isSelectedButton: allScreenController
                                      .hasStudentsFromNurseryToTenthGradeSelected
                                      .value ==
                                  1
                              ? true
                              : false,
                          ...
                          onPressed: () {
                            ...
                            allScreenController
                                .hasStudentsFromNurseryToTenthGradeSelector(1);
                          },
                        ),
                      ),
                      ...
                      Expanded(
                        child: CustomButton(
                          ...
                          onPressed: () {
                            ...
                            allScreenController
                                .hasStudentsFromNurseryToTenthGradeSelector(2);
                            print(allScreenController.Q1.value);
                          },
                        ),
                      ),
                    ],
          ...
          // Question Section 2
          allScreenController.hasStudentsFromNurseryToTenthGradeSelected == 1
              ? SurveyBackgroundContainer(
                  child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Column(
                    children: [
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) => Obx(
                          () => CustomButton(
                            isSelectedButton: allScreenController
                                    .howManyHasStudentsFromNurseryToTenthGradeSelected
                                    .value ==
                                index,
                            colorCode: 0xffDEEFFF,
                            ...
                            onPressed: () {
                              allScreenController
                                  .Q2
                                  .value = howManyStudents[index];
                              allScreenController
                                  .howManyHasStudentsFromNurseryToTenthGradeSelector(
                                      index);
                            },
                          ),
                        ),
